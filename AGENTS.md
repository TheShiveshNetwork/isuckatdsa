...
When adding a new note, the title is only in the markdown frontmatter (`title` field). Do not write the title as a heading (`# Title`) in the body - start directly with content or `##` sections.
